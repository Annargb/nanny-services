import{u as n,h as b,j as t,r as s,a as p,b as g,f as y,c as k}from"./index-8c36b85d.js";import{N as v,a as j,b as w}from"./NotFound-66de1de8.js";const N=e=>e.nannies.nannyList,C=e=>e.nannies.isVisibleButton,L=e=>e.nannies.error,S=e=>e.nannies.loading,M="#4fa94d",B={"aria-busy":!0,role:"progressbar"},E=n.div`
...
`,A=()=>{const[e,u]=s.useState(0),i=p(C),l=p(N),d=p(L),r=p(S),c=g(),o=s.useRef(null),[f,x]=s.useState(1),m=()=>{u(o.current.scrollTop)};s.useEffect(()=>{c(y(f))},[f,c]),s.useEffect(()=>{o.current&&(o.current.scrollTop=e)},[e]),s.useEffect(()=>{!r||!o.current||(o.current.scrollTop=o.current.scrollHeight)},[r]);const $=h=>{c(k(h.value))};return t.jsxs(q,{children:[t.jsx(v,{handleOptionChange:$}),!l.length&&!d&&!r&&t.jsx(j,{text:"There are no matching options for your request"}),r&&!d?t.jsx(F,{}):t.jsx(H,{ref:o,onScroll:m,children:l.map(h=>t.jsx(w,{nanny:h},h.id))}),i&&!r&&t.jsx(O,{type:"button",onClick:()=>{x(f+1)},children:"Load more"})]})};export{A as default};
